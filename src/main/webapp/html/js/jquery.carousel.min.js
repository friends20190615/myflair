(function(c) {
    function ga(z, s) {
        ...
        function ha(b) {
            var d = c('<a  class="carousel-item" href="'+j[b].link+'"><img src="'+j[b].path+'"/></a>').appendTo(i);
            Z.push(d);
        ...
        function o(b) {
            i.find(".carousel-item").each(function(d) {
                ...
                var left = Math.cos(-(p * d) + v * 0.5 + b * w) * a.settings.horizontalRadius + Q - h * 0.5 + h * (1 - r) / 2;
                console.log(left);
                var deg = (355 - left) * 0.32;
                e.css({
                    width: h *
                        r,
                    height: f * r,
